...
#include "koi8_ru.h"
*/
//#include "libiconv_cp1250.h"
int cp1250_mbtowc (conv_t conv, ucs4_t *pwc, const unsigned char *s, int n);
int cp1250_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, int n);
...
#include "cp775.h"
*/
//#include "libiconv_cp852.h"
int cp852_mbtowc (conv_t conv, ucs4_t *pwc, const unsigned char *s, int n);
int cp852_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, int n);
/*
#include "cp853.h"
#include "cp855.h"
#include "cp857.h"
